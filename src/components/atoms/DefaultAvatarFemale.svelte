<svg
  ...
  ><g
    ><rect fill="#F5EEE5" height="100" width="100" x="-27" y="24"></rect><rect
      fill="#D98C21"
      height="43"
      width="31"
      x="-3"
      y="65"></rect><rect fill="#CC751F" height="47" width="31" x="18" y="61"
    ></rect><path
    ...
    ><path
      ...
      fill="#A3705F"></path><circle cx="32" cy="69" fill="#262626" r="2"
    ></circle><circle cx="14" cy="69" fill="#262626" r="2"></circle><path
      d="M18.9,66.2c-1.5-1.9-3.8-2.3-5.6-2.2c-3,0-4.3,1-4.3,1l-1.3-1.5C8,63.3,9.6,62,13.4,62c3,0,5.6,1,7.2,3    L18.9,66.2z"
      fill="#CC9872"></path><path
      d="M26,79.4c-1.3-1.7-3.4-5.4-2.3-10.9c0.8-4.1,4-6.5,8.6-6.5c0,0,0.1,0,0.1,0c3.8,0,5.4,1.3,5.5,1.4L36.8,65    l0.6-0.8L36.8,65c0,0-1.3-1-4.3-1c-2.1,0-5.9,0.6-6.7,4.9c-1,4.7,0.8,7.8,1.9,9.3L26,79.4z"
      ...
      ><defs
        ><path
          d="M-3,69.3c2.4-0.9,7.2-3.5,12-11.9c6.8-12,17.2-6.5,20.5-2.6c0.4,0.4,0.9,0.2,0.9,0.2s8.6-3.7,12,3.8      c2.5,5.5,3.9,7.1,6.5,8.8v-7.9C49,44.2,39.5,44,39.1,44s-0.7,0-0.9-0.6C37.3,40.5,28,30.9,12.4,37S-3,65-3,65V69.3z"
          id="SVGID_5_"></path></defs
      ><clipPath id="SVGID_6_"
        ><use overflow="visible" xlink:href="#SVGID_5_"></use></clipPath
      ><path
